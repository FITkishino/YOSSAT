...
public class Report {
	 ...
	 *            user_ccl_analyze
	 */
	public Report(int report_side, int report_no, String report_name,
			String report_shortname, String report_jsp, String report_boolean,
			String enable_menu,
			String report_name_custom, String users_custom, String side_custom,
			String group_custom, String pos_custom) {
	 ...
	 */
	public Report(int report_side, int report_no, String report_name,
			String report_name_decode, String report_shortname, String xx) {
		this.report_side_ = report_side;
		this.report_no_ = report_no;
		this.report_name_ = report_name;
	 ...
	 * @param custom_value
	 */
	public Report(int cd_report_no, String nm_report, String nm_short,
	...
	public Report(String nm_report, String nm_short, String nm_report_jsp,
			String custom_value) {
		this.report_name_ = nm_report;
		this.report_shortname_ = nm_short;
		this.report_jsp_ = nm_report_jsp;
	...
	/**
	 * @param report_boolean_
	 *            設定する report_boolean_
	 */
	...
	/**
	 * @param report_shortname_
	 *            設定する report_shortname_
	 */
