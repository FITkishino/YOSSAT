...
public class User {
	...
	/** 予算権限基本プロパティ TODO:特処理いなげや*/
	private String pos_yos_custom_value_;
	/** 予算権限追加プロパティ TODO:特処理いなげや*/
	private String pos_yos_add_custom_value_;
	 ...
	 * 予算権限基本情報識別子(管理権限)
	 */
	String yos_admin_prefix = "y1";

	/**
	 * TODO:いなげや
	 * 予算権限基本情報識別子(店舗権限)
	 */
	String yos_tenpo_prefix = "y2";

	/**
	 * TODO:いなげや
	 * 予算権限追加情報識別子(特殊権限)
	 */
	String yos_add_prefix = "y3";

	/**
	 * TODO:いなげや
	 * 予算権限基本情報(店舗権限-店長・主任)
	 */
	String yos_tentyo = yos_tenpo_prefix + "1";

	/**
	 * TODO:いなげや
	 * 予算権限基本情報(店舗権限-部門担当者)
	 */
	String yos_bumon = yos_tenpo_prefix + "2";

	/**
	 * TODO:いなげや
	 * 予算権限基本情報の取得
	 * @return pos_yos_custom_value_
	 */
	public String getPos_yos_custom_value_() {
		return pos_yos_custom_value_;
	}
	 ...
	 * TODO:いなげや
	 * 予算権限追加情報の取得
	 * @return pos_yos_add_custom_value_
	 */
	public String getPos_yos_add_custom_value_() {
		return pos_yos_add_custom_value_;
	}
	 ...
	 * @param logo_ the logo_ to set
	 */
	public void setPos_yos_custom_value_() {
		// 基本情報
		String pos_yos_custom_value = "";
		for(String val : this.pos_custom_value_list_){
			if(yos_admin_prefix.equals(StringUtils.left(val, 2))){
				pos_yos_custom_value = val;
				break;
			}else if(yos_tenpo_prefix.equals(StringUtils.left(val, 2))){
				pos_yos_custom_value = val;
				break;
			}
		}
		this.pos_yos_custom_value_ = pos_yos_custom_value;
		// 追加情報
		String pos_yos_add_custom_value = "";
		for(String val : this.pos_custom_value_list_){
			if(yos_add_prefix.equals(StringUtils.left(val, 2))){
				pos_yos_add_custom_value = val;
				break;
			}
		}
		this.pos_yos_add_custom_value_ = pos_yos_add_custom_value;
	}
	...
	public boolean isAdminUser(){
		return yos_admin_prefix.equals(StringUtils.left(getPos_yos_custom_value_(), 2));
	}
	...
	public boolean isTenpoUser(){
		return yos_tenpo_prefix.equals(StringUtils.left(getPos_yos_custom_value_(), 2));
	}
	...
	public boolean isTentyo() {
		return yos_tentyo.equals(getPos_yos_custom_value_());
	}
	...
	public boolean isBumonTanto() {
		return yos_bumon.equals(getPos_yos_custom_value_());
	}
	...
	public boolean isSpecialTenpoUser(){
		return isTenpoUser() && yos_add_prefix.equals(StringUtils.left(getPos_yos_add_custom_value_(), 2));
	}
}
