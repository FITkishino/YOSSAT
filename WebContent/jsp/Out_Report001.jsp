...
<div id="tb" style="padding:2px;height:auto;display:none;">
	...
	<table class="area_query">
		<tr>
			...
			<td class="BC_class">
				<input type="text" id="<%=DefineReport.Text.BMN_ARA_RIT.getObj() %>" style="width:64px;" class="labelNum" readonly="readonly">
			</td>
			<%-- レイアウト調整用 --%>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.001.js?v=<%=prm %>"></script>
